...
public class DispatcherServlet extends HttpServlet {
    ...
    private final List<Class<?>> controllers = List.of(IndexController.class, UserController.class);
...
class GetDispatcher extends AbstractDispatcher {
    ...
    public GetDispatcher(Object instance, Method method, String[] parameterNames, Class<?>[] parameterClasses) {
        super();
        this.instance = instance; // Controller实例
        this.method = method; // Controller方法
        this.parameterNames = parameterNames; // 方法参数名称
        this.parameterClasses = parameterClasses; // 方法参数类型
    }
    ...
    public ModelAndView invoke(HttpServletRequest request, HttpServletResponse response)
        ...
        // 调用真实的 method，this.instance 是实例，arguments是装配好的参数
